...
export const newendpoint = `${newlocalhost}${apiURL}`;
...
export const getFieldListData= `${endpoint}/get_field_list_data/${db_name}/`;
export const getBinNumber= `${endpoint}/get_default_bin_number/${db_name}/`;
export const itemInspect= `${endpoint}/process_qr_inspect_data/${db_name}/`;
